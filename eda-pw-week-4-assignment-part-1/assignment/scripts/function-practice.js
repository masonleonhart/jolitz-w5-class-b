...
console.log(multiplyThree(145, 10, 2));
...
function cleverGetLast(array) {
  return array.pop();
}

console.log(cleverGetLast([1, 2, 3, 4]));
console.log(cleverGetLast([]));
